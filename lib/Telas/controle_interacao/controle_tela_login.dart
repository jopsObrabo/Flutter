...
class ControleTelaLogin {
  ...
  final controlador_nome_cliente = TextEditingController();
  final controlador_nome_oficina = TextEditingController();
  ...
  void cadastrar(BuildContext context,bool tipoUsuario) async {
    if (formkey.currentState!.validate()) {
      String login = controlador_login.text.trim();
      String senha = controlador_senha.text.trim();
      String nomeCliente = controlador_nome_cliente.text.trim();
      String nomeOficina = controlador_nome_oficina.text.trim();
